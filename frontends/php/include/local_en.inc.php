...
//	about.php
	define("S_ABOUT_ALLVIEW",			"About ALLVIEW");
	define("S_INFORMATION_ABOUT_ALLVIEW",		"Information about ALLVIEW (v1.0 Release)");
	define("S_HOMEPAGE_OF_ALLVIEW",			"Homepage of ALLVIEW");
	define("S_HOMEPAGE_OF_ALLVIEW_DETAILS",		"This is home page of ALLVIEW.");
	define("S_LATEST_ALLVIEW_MANUAL",		"Latest ALLVIEW Manual");
	define("S_LATEST_ALLVIEW_MANUAL_DETAILS",	"Latest version of the Manual.");
	define("S_DOWNLOADS",				"Downloads");
	define("S_DOWNLOADS_DETAILS",			"Latest ALLVIEW release can be found here.");
	...
	define("S_FORUMS_DETAILS",			"ALLVIEW-related discussion.");
	define("S_BUG_REPORTS",				"Bug reports");
	define("S_BUG_REPORTS_DETAILS",			"Bug in ALLVIEW ? Please, report it.");
	define("S_MAILING_LISTS",			"Mailing lists");
	define("S_MAILING_LISTS_DETAILS",		"ALLVIEW-related mailing lists.");
...
//	config.php
	define("S_CONFIGURATION_OF_ALLVIEW",		"Configuration of ALLVIEW");
	define("S_CONFIGURATION_OF_ALLVIEW_BIG",		"CONFIGURATION OF ALLVIEW");
...
//	items.php
	...
	define("S_ALLVIEW_AGENT",			"ALLVIEW agent");
	define("S_SNMPV1_AGENT",			"SNMPv1 agent");
	define("S_ALLVIEW_TRAPPER",			"ALLVIEW trapper");
	define("S_SIMPLE_CHECK",			"Simple check");
	define("S_SNMPV2_AGENT",			"SNMPv2 agent");
	define("S_ALLVIEW_INTERNAL",			"ALLVIEW internal");
	define("S_ALLVIEW_UNKNOWN",			"Unknown");
...
//	map.php
	...
	define("S_ALLVIEW_URL",				"http://www.myleftstudio.com");
...
//	Menu
	...
	define("S_MENU_STATUS_OF_ALLVIEW",		"STATUS OF ALLVIEW");
...
//	report1.php
	define("S_STATUS_OF_ALLVIEW",			"Status of ALLVIEW");
	define("S_STATUS_OF_ALLVIEW_BIG",		"STATUS OF ALLVIEW");
	define("S_VALUE",				"Value");
	define("S_ALLVIEW_SERVER_IS_RUNNING",		"ALLVIEW server is running");
