...
#ifndef _allview_subagent_h_
#define _allview_subagent_h_
...
#ifdef _WIN32
#define __allview_api __cdecl
#else
#define __allview_api
#endif
...
typedef struct
{
   ...
   int (__allview_api * handler_float)(char *,double *); /* Handler if return value is floating point numeric */
   int (__allview_api * handler_string)(char *,char **); /* Handler if return value is string */
} SUBAGENT_COMMAND;
