...
/*		 PARAMETER	,VAR	,FUNC,	TYPE(0i,1s),MANDATORY,MIN,MAX	*/
	...
	parse_cfg_file("/etc/allview/allview_snmptrapper.conf",cfg);
	...
	{
		CONFIG_PID_FILE=strdup("/tmp/allview_suckerd.pid");
	}
...
int main(int argc, char **argv)
{
	...
	printf("The binary is no ready yet! To be available in Allview 1.0beta11.\n");
	exit(-1);
...
/*
	...
	$ALLVIEW_SERVER $ALLVIEW_PORT $HOST:$KEY "$str"
*/
